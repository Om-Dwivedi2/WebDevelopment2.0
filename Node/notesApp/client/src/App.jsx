...
const App = () => {
  ...
  const [editNote, setEditNote] = useState({ title: "", description: "", id: "" , modalState: false});
  ...
  return (
    <>
      <main className="  w-full h-screen ">
        {editNote.modalState && <EditNotesModal editNote={editNote} setEditNote={setEditNote}/>}
        <div className="px-20 py-2">
          ...
          <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4  gap-5 py-5">
            {cardData.map((e) => {
              return (
                <Card id={e._id} title={e.title} description={e.description} setEditNote={setEditNote} editNote={editNote} />
              );
            })}
          </div>
        </div>
